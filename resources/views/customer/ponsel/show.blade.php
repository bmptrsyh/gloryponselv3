...
<div class="max-w-6xl mx-auto px-4 py-10 mb-4">
    ...
    <div class="grid md:grid-cols-2 gap-10">
        ...
        <div>
            ...
            <div id="harga-display" class="text-2xl font-bold text-gray-900 mb-4">Rp {{ number_format($produk->harga_jual , 0, ',', '.') }}</div>
            ...
            <div class="flex flex-wrap gap-4 mb-6">
                ...
                <a href="{{ route('tukar.tambah.create', $produk->id_ponsel) }}" class="bg-blue-600 text-white border border-purple-700 px-5 py-2 rounded-lg hover:bg-blue-700 disabled:opacity-50 inline-block text-center {{ $produk->stok <= 0 ? 'pointer-events-none opacity-50' : '' }}">
                    Tukar Tambah
                </a>
            </div>
            ...
            @forelse($produk->ulasan as $ulasan)
                <div class="bg-white p-6 rounded-2xl shadow-md border text-sm text-gray-700 mb-6">
                    <div class="flex items-center gap-2 mb-2">
                        <img src="{{ $ulasan->beliPonsel->customer->foto_profil }}" alt="{{ $ulasan->beliPonsel->customer->nama }}" width="30" height="30" class="rounded-full">
