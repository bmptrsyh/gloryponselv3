         ...
         <div class = "grid grid-cols-1 gap-4 mb-4">
            ...
            <div>
               ...
               <select name="jenis_transaksi"
                  class="form-control w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                  required>
            ...
            <div class="block font-medium text-gray-700 mb-1">
               ...
               <input type="text" name="jumlah" class="form-control border rounded-lg p-2 w-full"
                  oninput="formatRibuan(this)" placeholder="Masukkan nominal">
            </div>
            <div>
