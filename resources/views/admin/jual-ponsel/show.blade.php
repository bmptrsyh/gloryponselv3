...
<div class="container px-6 mx-auto grid">
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                <img src="{{ asset($pengajuan->gambar) }}" alt="{{ $pengajuan->merk }} {{ $pengajuan->model }}" class="w-full h-auto rounded-lg shadow-md">
                ...
                <div class="mt-6">
                    ...
                    <div class="flex items-center">
                        ...
                        <button onclick="openStatusModal({{ $pengajuan->id_jual_ponsel }}, '{{ $pengajuan->status }}')" class="ml-4 px-3 py-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-md active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                            Update Status
                        </button>
                    </div>
                </div>
        ...
        <div class="mt-8 flex justify-between">
            <a href="{{ route('admin.jual-ponsel.index') }}" class="px-4 py-2 text-sm font-medium leading-5 text-gray-700 transition-colors duration-150 bg-white border border-gray-300 rounded-md active:bg-gray-50 hover:bg-gray-50 focus:outline-none focus:shadow-outline-gray">
                Kembali ke Daftar
            </a>
            
            <form action="{{ route('admin.jual-ponsel.destroy', $pengajuan->id_jual_ponsel) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus pengajuan ini?');">
                @csrf
                @method('DELETE')
