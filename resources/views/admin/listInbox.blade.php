            ...
            <table class="inbox-table">
               ...
               <tbody>
                  @foreach ($customers as $customer)
                     <tr
                        class="{{ $customer->latestMessage && !$customer->latestMessage->is_read_by_admin ? 'unread' : '' }}">
                        ...
                        <td>
                           <span
                              class="status-badge {{ $customer->latestMessage && $customer->latestMessage->is_replied ? 'answered' : 'pending' }}">
