...
<body>
   ...
   <footer style="background-color: #111; color: #fff; padding: 60px 20px;">
      <div
         style="display: flex; flex-wrap: wrap; justify-content: space-between; gap: 30px; max-width: 1200px; margin: auto;">

         <!-- Kolom 1: Deskripsi -->
         <div style="flex: 1; min-width: 250px;">
            <h3 style="font-weight: bold;">Glory Ponsel</h3>
            <p style="line-height: 1.6;">is the leading ReCommerce Platform in Indonesia. We believe ReCommerce can help
               Emerging Middle-Class to upgrade their lifestyle, at affordable prices.</p>
         </div>
